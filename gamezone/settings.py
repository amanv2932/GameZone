...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "f5j6Yk2vR9pLm3Qx8sTn4aBc7dEf1GhJ0kLp2Qr5St8Uv6Wx9Yz",
)
...
STATIC_URL = "/static/"
STATICFILES_DIRS = [
    path for path in [BASE_DIR / "static", BASE_DIR / "gamezone" / "static"]
    if path.exists()
]
# Where `collectstatic` will collect static files for production
STATIC_ROOT = BASE_DIR / "staticfiles"

# Media files (user uploads) — not used by this project but useful for future
MEDIA_URL = "/media/"
MEDIA_ROOT = BASE_DIR / "media"

# Production security defaults (active only when DEBUG is False).
if not DEBUG:
    ...
    SECURE_HSTS_INCLUDE_SUBDOMAINS = os.environ.get("DJANGO_SECURE_HSTS_INCLUDE_SUBDOMAINS", "True").lower() in (
        "true",
        "1",
        "yes",
    )
